...
class MultiImageViewHolder extends RecyclerView.ViewHolder {
    ...
    public class NewsListRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        private static final int READ_COLOR;

        static {
            READ_COLOR = 0xFFA3A3A3;
        }
        ...
        public NewsListRecyclerAdapter(ApiResponse input){
            mApiResponse = input;
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch(viewType){
                ...
                case ApiSingleNews.mDisplayOneImage:
                    returnedViewHolder = new OneOrLessImageViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.news_list_single_image,parent,false));
                    break;
